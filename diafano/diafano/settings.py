"""
Django settings for diafano project.
...
SECRET_KEY = '1w6(xz8@)%c=(p2cf!qo%0_f$i(%d_!!b*6ctnakiw+8$#l$1('
...
WSGI_APPLICATION = 'diafano.wsgi.application'
...
#Backend Information for Authorization
